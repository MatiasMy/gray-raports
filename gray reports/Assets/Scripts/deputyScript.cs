        ...
        foreach (string todo in toDoList)
        {
            switch (todo)
            {
                ...
                case "A tip for the caseDeputy Weiß"://day 3
                    emailAnswers = emailAnswers + "Home investigation results_<link=\"b\"><u>Home investigation results</u></link>_Hi, Weiß here. I checked out Grau's house as you asked. The whole place felt like it'd been abandoned a while ago: there was noBODY there! There were a lot of crazy documents though. Like how his wife is the leader of the Future party and some documents related to some weird people not connected to the Future party. Sucks that the wife's locked up for doing something illegal. I also brained together that these weird extremists may have a place near the docks but im not sure where exactly, I can go chat them up next, or I mean investigate them if you wish._Deputy Weiß|";
                    break;
                ...
                case "Injustice!Deputy Weiß": // day 4
                    emailAnswers = emailAnswers + "Protest notes_Protest notes_I stuck to the sidelines of the protest, nothing really noteworthy happend, but I do have strong feelings towards Ms Graus detainment. No signes of Mr Grau_Deputy Weiß|";
                    break;
                ...
                case "Injustice!Deputy Black":// day 4
                    ...
                    break;
                case "DJ blueberry shot found deadDebuty Black": // day 5
                    ...
                    break;
                case "Break in at the goverment weapon storageDebuty Weiß": // day 5
                    emailAnswers = emailAnswers + "Nothing to report_Nothing to report_The army wouldntlet me near the storage or answer my questions. I snooped around for a bit but got nothing, sorry_Molly Weiß|";
                    break;
                case "DJ blueberry shot found deadDebuty Weiß": // day 5
                    ...
                    break;
                case "Break in at the goverment weapon storageDebuty Black": // day 5
                    emailAnswers = emailAnswers + "Resulsts: Weapon storage incident_Resulsts: Weapon storage incident_The army wont let anyone near the site. Looking around a bit I found a pair of cutters, they could have finger prints on them? So i checked myself but no. Nothing else notewrothy was found._Deputy Black|";
                    break;
                case "Corruption rumorsDebuty Weiß": // day 5
                    ...
                    break;
                case "Corruption rumorsDebuty Black": // day 5
                    ...
                    break;
                case "Results: Body in the riverDebuty Black": // day 6
                    emailAnswers = emailAnswers + "Results: Dock search_Results: Dock search_Yes sergeant, theres definitely something fishy here. One of the halls on the south side is locked but had activity inside late into the night. I also found a mural for Ms Grau so some of Mr Graus associates have atleast been here._Deputy Black|";
                    break;
                case "Results: Body in the riverDebuty Weiß": // day 6
                    ...
                    break;
                case "Shooting at the docks!Debuty Black": // day 6
                    emailAnswers = emailAnswers + "Results: Shooting_Results: Shooting_I can confirm sergeant that Mr Grau is behind this shooting, his associates and possibly him are still held up inside that hall. If you let me take a team there we can put an end to this._Deputy Black|";
                    break;
                case "Shooting at the docks!Debuty Weiß": // day 6
                    ...
                    break;
                case "Mr pikimusta causes corruption?Debuty Black": // day 6
                    ...
                    break;
                case "Mr pikimusta causes corruption?Debuty Weiß": // day 6
                    ...
                    break;
                case "Mr pikimusta questionable interviewDebuty Black": // day 6
                    emailAnswers = emailAnswers + "Results: Corruption_Results: Corruption_Captain Schwarz has been put into questioning, we'll get all the information out of him_Deputy Black|";
                    break;
                case "Mr pikimusta questionable interviewDebuty Weiß": // day 6
                    emailAnswers = emailAnswers + "I dont trust him_I dont trust him_ captain Schwarz was placed into questioning today regarding his corruption and ties to Ms Grauses case, she deserves justice._Molly Weiß|";
                    break;
                case "Finish the jobDebuty Weiß": // day 7
                    ...
                    break;
                case "Time to finish the jobDebuty Weiß": // day 7
                    emailAnswers = emailAnswers + "Im leaving_Im leaving_Sergeant, we got the bastard, but ive realized policework isnt for me. Im leaving to go help The future party and Ms Grau in getting out of prison._Molly Weiß|";
                    break;
                case "Finish the jobDebuty Black": // day 7
                    ...
                    break;
                case "Time to finish the jobDebuty Black": // day 7
                    emailAnswers = emailAnswers + "Mixed news_Mixed news_We were able to get Mr Grau and put him into jail with the help of deputy Black but unfortunately he lost his life in the fight. If you need support be sure to contact me._Lieutenant Stadt|";
                    break;
            }
        }
