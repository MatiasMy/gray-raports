        ...
        foreach (string todo in toDoList)
        {
            switch (todo)
            {
                ...
                case "Break in at the goverment weapon storageDebuty Black": // day 5
                    emailAnswers = emailAnswers + "Resulsts: Weapon storage incident_<link><u>Resulsts: Weapon storage incident</u></link>_The army wont let anyone near the site. Looking around a bit I found a pair of cutters, they could have finger prints on them?. Nothing else notewrothy was found._Deputy Black|";
                    break;
                ...
                case "Mr pikimusta questionable interviewDebuty Weiß": // day 6
                    emailAnswers = emailAnswers + "I dont trust him_I dont trust him_ captain Schwarz was placed into questioning today regarding his corruption and ties to Ms Grauses case, she deserves justice._Molly Weiß|";
                    break;
                case "Resulsts: Weapon storage incidentDebuty Black": // day 6
                    ...
                    break;
                case "Resulsts: Weapon storage incidentDebuty Weiß": // day 6
