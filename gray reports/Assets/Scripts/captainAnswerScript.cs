        ...
        foreach (string report in reportList)
        {
            switch (report)
            {
                ...
                case "Injustice!": //day 4
                    captainsAnswer = "Focus sergeant_Focus sergeant_This protest is not as important as catching Mr Grau. Make haste Mr Grau could have been behind the fire that took place at the fishing contest, we need to know what hes going to do next and stop him!_Captain Schwarz";
                    break;
                ...
                case "Mr pikimusta causes corruption?": // day 6 (good ending)
                    captainsAnswer = "Time to finish the job_<link=\"a\"><u>Time to finish the job</u></link>_Mornin serg, Captain Schwarz has been put into questioning regarding his connections to Mr Pikimusta and Ms Graus case. As you probably know there was some shooting at the docks, the situation is still going on, you should send one of youre deputies there to finish this._Lieutenant Stadt";
                    break;
